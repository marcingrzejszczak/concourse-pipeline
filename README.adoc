...
In case you don't have Docker Machine:

[source,bash]
----
git clone https://github.com/marcingrzejszczak/concourse-pipeline
cd concourse-pipeline
./start.sh
----

If you have Docker Machine (e.g. running on `192.168.99.100`):
